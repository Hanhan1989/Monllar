var uploadHBR = function () {
    var e, a = 6, t = "Adicionar", n = "Clique ou arraste aqui uma foto", i = "Clique aqui para remover a foto",
        s = "fa fa-camera", d = "fa fa-times", r = ["image/jpeg", "image/png"], o = 0;
    ...
    function c() {
        ...
        function i(a) {
            ...
            $.each(a, function (a, i) {
                $.each(r, function (s, d) {
                    if (void 0 !== $(e + " #base64_" + a).val() && d === i.type) if (parseInt($(e + " #base64_" + a).val().length) > 0) for (var r = 0, o = t + 1; o < $(e + ' input[name*="base"]').length; o++) r || 0 !== parseInt($(e + " #base64_" + o).val().length) || (n(i, o), t = o, r++); else n(i, a)
                })
            })
        }
    ...
    return {
        init: function (l) {
            Modernizr.draganddrop ? (void 0 !== l.max && (a = parseInt(l.max)), void 0 !== l.textNew && (t = l.textNew), void 0 !== l.textTitle && (n = l.textTitle), void 0 !== l.textTitle && (n = l.textTitle), void 0 !== l.mimes && (r = l.mimes), void 0 !== l.start && (o = l.start), function (l) {
                ...
                if (f.length > 0) for (f.html(""); o < a; o++) f.append((c = o, u = r.join(","), '<div class="box-drag column" draggable="true"><input type="hidden" name="base[]" id="base64_' + c + '" data-id="' + c + '"><div class="form-group"><div class="col-md-12 no-padding uploadArea" data-index="' + c + '"><span class="new" id="new_' + c + '" title="' + n + '" data-index="' + c + '"><input type="file" class="fileHidden hidden" multiple="" accept="' + u + '" id="hidden_' + c + '" name="path_imagen_' + ( c + 1)+ '" data-index="' + c + '"><i class="' + s + '"></i><p>' + t + '</p></span><span class="image-preview hidden" id="prev_' + c + '"><div class="remove" title="' + i + '" data-index="' + c + '"><i class="' + d + '"></i></div><img class="img-responsive" src=""></span></div></div></div>')); else console.log("Target not found : " + l.target)
